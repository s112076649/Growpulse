          ...
          <div style={{ maxWidth: 900 }}>
              ...
              <div className="col">
                <div className={`card gsbox`} style={{ overflow: "hidden" }}>
                  <GetStartedStep
                    ...
                    text={
                      <>
                        GrowPulse needs read access to where your experiment
                  ...
                  <GetStartedStep
                    ...
                    text={
                      <p>
                        ...
                        With GrowPulse, you can build out an entire metric
            ...
            <div className="alert alert-info text-center">
              <p>
                ...
                experiment first to get a feel for the GrowPulse platform.
              </p>
                  ...
                  <GetStartedStep
                    ...
                    text={
                      <p>
                        ...
                        platform? Connect GrowPulse to your data warehouse and
