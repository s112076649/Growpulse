...
export function getChecklistItems({
  ...
  items.push({
    ...
    display: (
      <>
        Integrate GrowPulse into your app by adding an SDK Connection.{" "}
    ...
    items.push({
      ...
      display: (
        <>
          ...
          and a <strong> trackingCallback </strong>into the GrowPulse SDK.
        </>
      ),
    });
    items.push({
          ...
          <Checkbox
            ...
            description={
              item.status === "incomplete" && item.type === "auto"
                ? "GrowPulse will mark this as completed automatically when you finish the task."
                : item.status === "incomplete"
                ? "You must manually mark this as complete. GrowPulse is unable to detect this automatically."
                : undefined
            }
            error={item.warning}
            errorLevel="warning"
