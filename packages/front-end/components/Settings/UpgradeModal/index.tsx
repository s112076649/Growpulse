...
import { getGrowPulseBuild, isCloud } from "@/services/env";
...
export default function UpgradeModal({
      ...
      await apiCall<{
        ...
        body: JSON.stringify({
          ...
          context: {
            ...
            currentBuild: getGrowPulseBuild(),
            ctaSource: source,
          },
        }),
      });
  ...
  const bullets: Partial<Record<CommercialFeature, string>> = {
    ...
    "cloud-proxy":
      "Use a self-hosted GrowPulse proxy in front of our Cloud CDN",
    ...
    <div>
      {showSHProTrial ? (
        ...
        <Modal
          ...
          close={close}
          size="lg"
          header={<>Get more out of GrowPulse</>}
          loading={loading}
          cta={
            <>
              {featureFlagValue === "UPGRADE-ONLY" ||
