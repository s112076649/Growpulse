...
export default function DataSourceDiagram({
  ...
  return (
    <div className={className}>
      <h3 className="mb-2">How A/B Test Analysis Works at GrowPulse</h3>
      <ol>
        <li>
        ...
        <li>
          Connect GrowPulse to your warehouse and define metrics using SQL
        </li>
        <li>
          GrowPulse queries your warehouse and uses a stats engine to analyze
          experiment results
        </li>
      </ol>
      Example:
      <div className="d-flex align-items-center position-relative mt-3">
        ...
        >
          ...
          />
          <div className="col">
            <h5 className="mb-0">GrowPulse</h5>
          </div>
        </div>
      </div>
    </div>
