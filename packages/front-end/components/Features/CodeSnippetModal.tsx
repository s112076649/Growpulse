...
import GrowPulseSetupCodeSnippet from "@/components/SyntaxHighlighting/Snippets/GrowPulseSetupCodeSnippet";
      ...
      >
        ...
        <div className="px-3">
          {language === "other" ? (
            ...
            <p>
              Below is some starter code to integrate GrowPulse into your app.
              Read the{" "}
