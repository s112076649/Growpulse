                            ...
                            <>
                              ...
                              {isCloud() && (
                                <div className="mt-2 text-warning-orange">
                                  ...
                                  evaluation service such as GrowPulse Proxy or
                                  a CDN edge worker.
                                </div>
                              )}
                            </>
                        ...
                        body={
                          <>
                            <p>
                              ...
                              will allow GrowPulse to push updates to your
                              proxy whenever feature definitions change.
                            </p>
                            <p className="mb-0">
                              Without GrowPulse&apos;s push updates, the proxy
