    ...
    if (eventTracker === "mixpanel") {
      attributesSnippets.push(
        <Box>
          ...
          to pass this id to GrowPulse. This might need to be adjusted to wait
          for Mixpanel to load.
          <Code
            language="javascript"
            code={`
// Add the mixpanel user id to the GrowPulse attributes when it loads:
...
`.trim()}
      ...
      attributesSnippets.push(
        <Box>
          ...
          the ID needs to be passed to GrowPulse. This may need to be adjusted
    ...
    domain_user_id: this.sp.getDomainUserId(),
      ...
      attributesSnippets.push(
        <Box>
          ...
          (recommended) you need to pass in this ID to GrowPulse.
          <Code
            language="javascript"
    ...
    function () {
      ...
      attributesSnippets.push(
        <Box>
          ...
          (recommended), the ID needs to be passed to GrowPulse. This might
          need to be adjusted to wait for Amplitude to load.
          <Code
            language="javascript"
            code={`// Add the Amplitude device id to the GrowPulse attributes when it loads:
growthbook.updateAttributes({ 
      ...
      attributesSnippets.push(
        <>
          <p>
            ...
            set the following ones. This must be added BEFORE the GrowPulse
            snippet.
          </p>
          <Code
            language="html"
