...
import { getGrowPulseBuild } from "@/services/env";
...
const Layout = (): React.ReactElement => {
  ...
  const growpulse = useGrowPulse<AppFeatures>();

  // app wide a-a tests
  growpulse?.isOn("gp-ax5-bandit");
  growpulse?.isOn("gp-ax10-bandit");
                  ...
                  {settings?.customized && settings?.logoPath ? (
                    ...
                    <>
                      <img
                        ...
                        alt="GrowPulse"
                        src="/logo/growpulse-logomark-white.svg"
                      />
                      <img
                        className={styles.logotext}
                        alt="GrowPulse"
                        src="/logo/growpulse-name-white.svg"
                      />
                    </>
                  )}
                </div>
        ...
        {build.sha && (
          <div className="px-3 my-1 text-center">
            <small>
              ...
              <a
                href={`https://github.com/growpulse/growpulse/commit/${build.sha}`}
                target="_blank"
                rel="noreferrer"
