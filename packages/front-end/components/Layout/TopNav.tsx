...
const TopNav: FC<{
  ...
  return (
    <>
      <Head>
        <title>GrowPulse &gt; {pageTitle}</title>
      </Head>
      {editUserOpen && (
        <Modal
        ...
        >
          ...
          <label className="mr-3">
            ...
            <Tooltip
              body={
                "GrowPulse adds on-screen confetti celebrations randomly when you complete certain actions like launching an experiment. You can disable this if you find it distracting."
              }
            />
          </label>
          <Toggle
