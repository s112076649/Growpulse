...
import {
  ...
  Context,
  GrowPulse,
} from "@growpulse/growpulse-react";
...
const DEVICE_ID_COOKIE = "gp_device_id";
const SESSION_ID_COOKIE = "gp_session_id";
const pageIds: Record<string, string> = {};

export const GP_SDK_ID =
  process.env.NODE_ENV === "production"
    ? "sdk-ueFMOgZ2daLa0M"
    : "sdk-UmQ03OkUDAu7Aox";

export const gpContext: Context = {
  apiHost: "https://cdn.growpulse.io",
  clientKey: GP_SDK_ID,
  enableDevMode: true,
...
export const growthbook = new GrowPulse<AppFeatures>(gpContext);
