...
import { useFeature } from "@growpulse/growpulse-react";
import {
  getGrowPulseBuild,
...
export function UserContextProvider({ children }: { children: ReactNode }) {
  ...
  // User/build GrowPulse attributes
  useEffect(() => {
    let anonymous_id = "";
  ...
  useEffect(() => {
    ...
    // Error tracking only enabled on GrowPulse Cloud
    if (isSentryEnabled()) {
    ...
    <UserContext.Provider
      value={{
        ...
        hasCommercialFeature: (feature) => {
          ...
          return feature === "schedule-feature-flag" || 
                 feature === "audit-logging" || 
                 feature === "teams" || 
                 feature === "regression-adjustment" || 
                 feature === "metric-populations" || 
                 feature === "multi-metric-queries";
        },
        watching: watching,
        canSubscribe,
