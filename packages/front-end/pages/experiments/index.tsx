...
import LinkDocIcon from "@/components/LinkDocIcon";
...
const ExperimentsPage = (): React.ReactElement => {
  ...
  return (
    <>
            ...
            <TabsContent value="experiments">
              ...
              {!hasExperiments && analyzeExisting ? (
                <EmptyState
                  ...
                  leftButton={
                    <LinkButton
                      href="https://docs.growpulse.io/app/importing-experiments"
                      variant="outline"
                      external
                    >
                      View docs
                ...
                <>
                  <EmptyState
                    ...
                    leftButton={
                      <LinkButton
                        href="https://docs.growpulse.io/experiments"
                        variant="outline"
                        external
                      >
                        View docs
                ...
                hasExperiments && (
                  <>
                    <div className="row align-items-center mb-3">
                      ...
                      <div className="col-auto">
                        <Link
                          href="https://docs.growpulse.io/using/growpulse-best-practices#syntax-search"
                          target="_blank"
                        >
                          <Tooltip
      ...
      {filtersChanged && (
        <Modal
          modalState={[!!filtersChanged, () => setFiltersChanged(false)]}
          size="lg"
          header={
            <div className="d-flex align-items-start justify-content-between">
              <div>
                ...
                <div className="text-muted">
                  Learn how to implement experiments in{" "}
                  <a
                    href="https://docs.growpulse.io/app/importing-experiments"
                    target="_blank"
                    rel="noreferrer"
                  ...
                  >
                    Search docs for implementation examples
                  </a>
                </div>
              </div>
              <button
