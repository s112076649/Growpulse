...
const ExperimentsPage = (): React.ReactElement => {
  ...
  const [banditEmpty, setBanditEmpty] = useState(false);
    ...
    return (
      <div className="contents container-fluid pagecontents">
        <PremiumEmptyState
          ...
          learnMoreLink="https://docs.growpulse.io/bandits/overview"
        />
      </div>
    );
  }
        ...
        <div className="mb-3 mt-2">
          <div className="filters md-form row mb-3 align-items-center">
            ...
            <EmptyState
              ...
              subtitle="Optimize for the best performing variations in real-time"
              cta="Create Bandit"
