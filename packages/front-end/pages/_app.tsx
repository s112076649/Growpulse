...
import { growthbookTrackingPlugin } from "@growpulse/growpulse/plugins";
...
function App({
  ...
  useEffect(() => {
    // Load feature definitions JSON from GrowPulse API
    growthbook.init({ streaming: true }).catch(() => {
      console.log("Failed to fetch GrowPulse feature definitions");
    });
  }, []);
      ...
      {ready || noLoadingOverlay ? (
        ...
        <div className="container">
          <div className="alert alert-danger">
            Error Initializing GrowPulse: {error}
          </div>
        </div>
      ) : (
        <LoadingOverlay />
