          ...
          <div className="appbox p-4">
            <div className="row">
              ...
              <div className="col">
                <Link
                  ...
                  onClick={() =>
                    setStep({
                      step: "Integrate the GrowPulse SDK into your app",
                      source: "experiments",
                ...
                >
                  Integrate the GrowPulse SDK into your app
                </Link>
                <Box mt="2">Allow GrowPulse to communicate with your app.</Box>
            ...
            <div className="row">
              ...
              <div className="col">
                ...
                <Box mt="2">
                  Allow GrowPulse to query your warehouse to compute traffic
