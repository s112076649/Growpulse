...
function OrganizationRow({
  ...
  const [hasGrowthbookClickhouse, setHasGrowthbookClickhouse] = useState(
    datasources.find((ds) => ds.type === "growpulse_clickhouse") ? true : false
  );
            ...
            <Tooltip
              body={
                hasGrowthbookClickhouse
                  ? "Already has an Inbuilt GrowPulse Datasource"
                  : "Create Inbuilt GrowPulse Clickhouse DataSource"
              }
            >
              <a
                href="#"
