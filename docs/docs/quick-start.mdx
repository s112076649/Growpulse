---
title: Quick Start Guide to GrowPulse
description: The basic instructions for getting started with GrowPulse
...
This guide walks you through the basics of a full integration of GrowPulse for both feature flagging and A/B testing.
You can use GrowPulse for feature flags, running no-code experiments with a visual editor, analyzing experiment results, or any combination of the above. Feel free to skip to the sections that best apply to your use case.
...
Use GrowPulse hosted on our **cloud** or **self-host** it. For the easiest setup, [sign up for a free account](https://app.growpulse.io). If you prefer to self-host, follow the [instructions here](/self-host) or on our GitHub page.

Once you have a GrowPulse account set up, you're ready to start feature flagging and experimenting!

## Feature Flags

### Step 1. Add an SDK Connection

To use Feature Flags, use an SDK Connection to connect GrowPulse to your app.

From the menu, choose **SDK Configuration** &rarr; **SDK Connections**. Then, click **Add SDK Connection**.

Name your SDK connection, select the language you're using in your application, and configure additional options. Don't worry! These settings can be changed at any time. To use GrowPulse with multiple languages, create a separate SDK Connection for each one.
...
### Step 2. Integrate GrowPulse Into Your Application

Use GrowPulse SDKs to evaluate feature flags and run experiments. Tailored instructions based on your selected language and settings will guide you through the installation process. The [full SDK docs](/lib) are also available.

The basics of installing the SDKs are:

- Grab the [GrowPulse SDK](/lib) package for your language.
...
If your application has multiple languages or platforms, you can create a separate SDK Connection for each one. GrowPulse features and experiments will work the same across all languages, platforms, and environments!
...
:::info
Requires a Pro or Enterprise license. [Start a 14-day free trial to try it out](https://www.growpulse.io/get-started#create-free-account).
:::
...
### Step 3. Install the GrowPulse Chrome or Firefox Extension

Before using the Visual Editor, you must install our [Chrome](https://chromewebstore.google.com/detail/growpulse-devtools/opemhndcehfgipokneipaafbglcecjia) or [Firefox](https://addons.mozilla.org/en-US/firefox/addon/growpulse-devtools/) browser extension.
...
Use the editor to make changes to your site. To return to GrowPulse, click the **Done** button. We have an entire guide dedicated to [setting up and using the Visual Editor](/app/visual), so check it out if you get stuck or want to try some of the more advanced features like drag-and-drop reordering.

### Step 5. Start Your Experiment!

When you are ready, click the **Start Experiment** button. Within seconds, GrowPulse will begin to bucket users into your variations. You can just as easily stop or make changes if needed.

Follow the Experiment Analysis section below to learn how to connect GrowPulse to your data and view results. Depending on the analytics tool and data warehouse that you use, it can take up to 24 hours for results to start showing up after you start an experiment.

## Experiment Analysis

### Step 1. Connect to Your Data Warehouse

GrowPulse is warehouse native: it connects to your data warehouse and queries it to get the results of your experiments.
...
GrowPulse is extremely flexible and can support almost any schema structure with a bit of configuration.
...
To connect GrowPulse to your data warehouse, add a data source. Go to **Metrics and Data** &rarr; **Data Sources**. From here, click **Add Data Source**. Follow the instructions to connect to your data warehouse and event trackers. Providing your data warehouse information enables GrowPulse to connect to your data warehouse and execute queries. The event tracker information allows GrowPulse to
...
Metrics in GrowPulse are powerful and have many advanced settings. Read about them on our [Fact Tables page](/app/metrics).

### Step 3. View Experiment Results

Go to the **Experiments** page. If you implemented an experiment using feature flags or our Visual Editor, your experiment will already be listed. Click through to it. If you ran your experiment outside of GrowPulse instead, that's fine, too! Add a new experiment and select the **Analyze Existing** option.
...
<div className="row is-multiline">
    <div className="col col--4">
        <ButtonCard
            to={'/self-host'}
            title="Self-Host"
            description="Run GrowPulse on your own infrastructure"
            style={{ height: '100%' }}
        ></ButtonCard>
    </div>
    <div className="col col--4">
        <ButtonCard
            to={'/lib'}
            title="SDK Docs"
            description="Connect GrowPulse to your application"
            style={{ height: '100%' }}
            color="default"
        ></ButtonCard>
    </div>
